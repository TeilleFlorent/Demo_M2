    ...
    void Shader::set_shader(const GLchar* vertexPath, const GLchar* fragmentPath)
    {
    ...
    void Shader::set_shader2(const GLchar* vertexPath,const GLchar* geoPath, const GLchar* fragmentPath)
    {
        std::string vertexCode;
        std::string geoCode;
        std::string fragmentCode;
